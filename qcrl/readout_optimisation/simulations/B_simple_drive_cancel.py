...
TRANS_DRIVE_AMP = RES_DRIVE_AMP * SIN_ANGLE

RES_COMPLEX_STATE = -1j * 5.83  # RES_DRIVE_AMP * 0.2
...
fig1, ax1 = simple_plotter_debug(
    ...
    name_1="res",
    name_2="trans",
    fig_name=f"Ground Simple Cancel, Max Separation: {max_separation}",
)
...
fig2, ax2 = simple_plotter_debug(
    ...
    name_1="res",
    name_2="trans",
    fig_name=f"Excited Simple Cancel, Max Separation: {max_separation}",
)

fig, ax = plt.subplots(1, num="Separation B")
