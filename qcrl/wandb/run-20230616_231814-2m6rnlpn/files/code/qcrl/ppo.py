...
if __name__ == "__main__":
    ...
    for update in tqdm(range(1, args.num_updates + 1)):
        ...
        batch_mean_reward = info["mean reward"]
        batch_mean_max_photon = info["mean max photon"]
        batch_mean_max_separation = info["mean max separation"]
        ...
        if args.print_debug:
            ...
            max_separation_obtained = info["max separation"]
            print("\n Update", update)
            ...
            print(f"Max Separation Obtained: {max_separation_obtained}")
